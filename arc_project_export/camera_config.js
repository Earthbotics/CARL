...
var lastSentObject = "";
var lastSentTime = 0;
var timeoutDuration = 120000; // 120 seconds in milliseconds
...
while (true) {
    ...
    // Wait 60 seconds before allowing next detection (as requested)
    print("Waiting 60 seconds before next detection...");
    sleep(60000); // 60 second timeout
