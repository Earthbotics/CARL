...
set SUBFOLDERS=concepts memories goals needs senses skills places people values beliefs conflicts humor exercise assets commonsense logs games social_prompts things
...
for %%F in (
	...
	"%BASE_DIR%\voltage_log.json"
	"%BASE_DIR%\short_term_memory.json"
	"%BASE_DIR%\working_memory.json"
) do (
    if exist %%F (
...
:: Delete any evaluation_consciousness_*.txt files in the same folder as the .ini
echo Looking for evaluation_consciousness_*.txt files...
del /q /s "%BASE_DIR%\evaluation_consciousness_*.txt"

:: Delete any openai_call_summary_*.txt files in the same folder as the .ini
echo Looking for openai_call_summary_*.txt files...
del /q /s "%BASE_DIR%\openai_call_summary_*.txt"	
	
:: Delete any linkedin_article_*.html files in the same folder as the .ini
echo Looking for linkedin_article_*.html files...
del /q /s "%BASE_DIR%\linkedin_article_*.html"	
